        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-red-sunglo bold uppercase">Update Category of {{$data->name}}</span>
                </div>
            </div>
            <div class="portlet-body form">
                <form method="post" action="{{route('admin-cat-update',$data->id)}}" class="form-horizontal" enctype="multipart/form-data">
                    {{csrf_field()}}
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            <div class="col-md-10">
                                ...
                                <img id="blah" src="{{isset($data->photo)?URL::asset('public/uploads/categories/'.$data->photo):''}}" style="max-width: 400;max-height: 200px">
