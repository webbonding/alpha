        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-red-sunglo bold uppercase">Update Course of {{$data->name}}</span>
                </div>
            </div>
            <div class="portlet-body form">
                <form method="post" action="{{route('admin-course-update',$data->id)}}" class="form-horizontal" enctype="multipart/form-data">
                    {{csrf_field()}}
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group {{ $errors->has('book_list') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                <textarea class="form-control ckeditor" placeholder="Book List" name="book_list"  id="book_list">{{ (old('book_list')!="") ? old('book_list') : $data->book_list }}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('additional_resources') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                <textarea class="form-control ckeditor" placeholder="Additional Resources" name="additional_resources"  id="additional_resources">{{ (old('additional_resources')!="") ? old('additional_resources') : $data->additional_resources }}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('prior_knowledge') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                <textarea class="form-control ckeditor" placeholder="Prior Knowledge" name="prior_knowledge"  id="prior_knowledge">{{ (old('prior_knowledge')!="") ? old('prior_knowledge') : $data->prior_knowledge }}</textarea>
                      	...
                      	<div class="form-group {{ $errors->has('analysis_basics') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                <textarea class="form-control ckeditor" placeholder="Analysis Basics" name="analysis_basics"  id="analysis_basics">{{ (old('analysis_basics')!="") ? old('analysis_basics') : $data->analysis_basics }}</textarea>
						...
						<div class="form-group {{ $errors->has('functions') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                <textarea class="form-control ckeditor" placeholder="Functions" name="functions"  id="functions">{{ (old('functions')!="") ? old('functions') : $data->functions }}</textarea>
                         ...
                         <div class="form-group">
                            <div class="col-md-10">
                                <img id="blah" src="{{isset($data->image)?URL::asset('public/uploads/course/'.$data->image):''}}" style="max-width: 400;max-height: 200px">
                            </div>
                        </div>
                        ...
                        <div class="form-group {{ $errors->has('original_price') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                <input type="number" class="form-control" placeholder="Original Price" name="original_price" value="{{ (old('original_price')!="") ? old('original_price') : $data->original_price}}"/>
                        ...
                        <div class="form-group {{ $errors->has('discount_percentage') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                <input type="number" class="form-control" placeholder="Discount Percentage" name="discount_percentage" value="{{ (old('discount_percentage')!="") ? old('discount_percentage') : $data->discount_percentage}}"/>
                        ...
                        <div class="form-group {{ $errors->has('hours_left_for_this_price') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                <input type="number" class="form-control" placeholder="Hours Left For This Price" name="hours_left_for_this_price" value="{{ (old('hours_left_for_this_price')!="") ? old('hours_left_for_this_price') : $data->hours_left_for_this_price}}"/>
                        ...
                        <div class="form-group {{ $errors->has('long_description') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                <textarea class="form-control ckeditor" placeholder="Long Description" name="long_description"  id="body">{!! (old('long_description')!="") ? old('long_description') : $data->long_description !!}</textarea>
                            ...
                            <div class="col-md-10">
                                <div class="radio-list">
                                    <label class="radio-inline">
                                        <input type="radio" name="featured" value="1" {{ ($data->featured == '1') ? 'checked' : '' }}> Yes
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="featured" value="0" {{ ($data->featured == '0') ? 'checked' : '' }}> No
                                    </label>
