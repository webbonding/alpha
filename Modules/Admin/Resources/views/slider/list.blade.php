...
<div class="portlet light bordered">
    <div class="portlet-title">
        ...
        <div class="pull-right"><a href="{{route('admin-slider-create')}}" class="btn btn-success"><i class="fa fa-plus"></i> Add New</a></div>
    </div>
    <div class="portlet-body ">
        <div class="clearfix">
            <div class="table-responsive">
                <table class="ui celled table" cellspacing="0" width="100%" id="slider-management">
                    <thead>
                        <tr>
                            <th>#</th>
                            <th>Image</th>
