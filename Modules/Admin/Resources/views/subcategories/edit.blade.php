...
<ul class="page-breadcrumb breadcrumb">
    ...
    <li>
        <a href="{{Route('admin-subcat-index')}}">Subcategory</a>
        <i class="fa fa-circle"></i>
    </li>
    <li>
        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-red-sunglo bold uppercase">Update Subcategory of {{$data->name}}</span>
                </div>
            </div>
            <div class="portlet-body form">
                <form method="post" action="{{route('admin-subcat-update',$data->id)}}" class="form-horizontal" enctype="multipart/form-data">
                    {{csrf_field()}}
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            <div class="col-md-10">
                                <img id="blah" src="{{isset($data->photo)?URL::asset('public/uploads/subcategories/'.$data->photo):''}}" style="max-width: 400;max-height: 200px">
                            </div>
                        </div>
                    ...
                    <div class="form-actions">
                        <div class="row">
                            <div class="col-md-12 text-center">
                                <a href="{{Route('admin-subcat-index')}}" class="btn btn-primary">Cancel</a>
