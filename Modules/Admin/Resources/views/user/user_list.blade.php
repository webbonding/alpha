...
<div class="portlet light bordered">
    <div class="portlet-title">
        ...
        <!--<div class="pull-right"><a href="{{route('user-add')}}" class="btn btn-success"><i class="fa fa-plus"></i> Add New</a></div>-->
        <!--<div class="pull-right"><a href="{{route('users-csv')}}" class="btn btn-success"><i class="fa fa-file-excel-o"></i> Download csv</a></div>-->
    </div>
    <div class="portlet-body ">
        <div class="clearfix">
            <div class="table-responsive">
                <table class="ui celled table" cellspacing="0" width="100%" id="user-management">
                    <thead>
                        <tr>
                            <th>#</th>
                            <th>Image</th>
