...
// Search panel
	var searchBtnmobile = $('#searchmobile').children('.searchBtnmobile'),
		searchPanelmobile = searchBtnmobile.next(),
		searchPmobile = searchBtnmobile.parent();
		...
		if(!_t.hasClass('active')) {
			...
			.removeClass('glyphicon-search icon-white')
			.addClass('glyphicon-remove');
			searchPanelmobile.show();
		} else {
			_t.removeClass('active')
			.find('span')
			.addClass('glyphicon-search icon-white')
			.removeClass('glyphicon-remove');
			searchPanelmobile.hide();
		}
	...
	$(document).click(function(){
		searchBtnmobile.removeClass('active')
			...
			.addClass('glyphicon-search icon-white')
			.removeClass('glyphicon-remove');
		searchPanelmobile.hide(0);
	});

	searchPmobile.click(function(event){
		event.stopPropagation();
	});
// END Search panel
