...
{
    if ($val == 'SELECT STATE') {
        var options = '<option value="">' + 'Select State first' + '</option>';
    ...
    if ($val == 'Orissa') {
        var orissa = ["Angul", "Boudh (Baudh)", "Balangir", "Bargarh", "Balasore (Baleswar)", "Bhadrak", "Cuttack", "Deogarh (Debagarh)"
        ,"Dhenkanal", "Ganjam", "Gajapati", "Jharsuguda", "Jajpur", "Jagatsinghapur", "Khordha", "Keonjhar (Kendujhar)","Kalahandi"
        ,"Kandhamal", "Koraput", "Kendrapara", "Malkangiri", "Mayurbhanj", "Nabarangpur", "Nuapada", "Nayagarh","Puri"
